...
const (
	...
	pageUsersTitle           = "ユーザー"
	pageAdminsTitle          = "管理者"
	pageConnectionsTitle     = "接続"
	pageStatusTitle          = "ステータス"
	pageFoldersTitle         = "フォルダ"
	pageGroupsTitle          = "グループ"
	pageProfileTitle         = "プロフィール"
	pageChangePwdTitle       = "パスワード変更"
	pageMaintenanceTitle     = "メンテナンス"
	pageDefenderTitle        = "ディフェンダー"
	pageForgotPwdTitle       = "管理者 - パスワードをお忘れの方"
	pageResetPwdTitle        = "管理者 - パスワードをリセット"
	pageSetupTitle           = "最初の管理者ユーザーを作成する"
